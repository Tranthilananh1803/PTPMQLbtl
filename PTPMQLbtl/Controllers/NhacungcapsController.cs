...
namespace PTPMQLbtl.Controllers
{
    public class NhacungcapsController : Controller
    {
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            bulkcopy.DestinationTableName = "Nhacungcaps";
            bulkcopy.ColumnMappings.Add(0, "TenNCC");
